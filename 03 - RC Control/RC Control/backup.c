...
volatile unsigned int servo[4] = {2300, 2300, 2300, 2300}; //Initial speed - 700 to 2000 for ESC Turnigy Plush
...
int main(void){
	...
	while(1){
		...
		if(timeS > 300){
			...
			{	
				computedThrottle = map(time, rcMinUs, rcMaxUs, motorMinUs, motorMaxUs);
			}
